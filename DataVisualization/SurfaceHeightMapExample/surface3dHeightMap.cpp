    ...
    : QMainWindow(parent)
{
    ...
    QObject::connect(selectHeighMap, SIGNAL(clicked()),
                     this, SLOT(onSelectHightMapClick()));
...
void SurFace3D::onSelectHightMapClick()
{
